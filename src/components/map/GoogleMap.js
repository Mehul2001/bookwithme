        ...
        >
            ...
            {isLocationLoaded && isError &&
                <InfoWindow position={coordinates} options={{ maxWidth: 300 }}>
                    <div>
                        Uuuups, there is a problem to find location on the map, we are trying to resolve
                        problem as fast as possible. Contact host for additional informations if you are
                        still interested in booking this place. We are sorry for inconvinence.
                </div>
                </InfoWindow>}
        ...
        getGeocodedLocation() {
            ...
            if (this.cacher.isValueCached(location)) {
                ...
                this.geocodeLocation(location).then((coordinates) => {
                    ...
                    (error) => {
                        this.setState({ isError: true, isLocationLoaded: true, isError: true });
                    });
            }
        }
        render() {
